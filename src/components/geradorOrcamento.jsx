...
const GeradorOrcamento = () => {
  ...
  const calcularTudo = (valoresDaTela) => {
    ...
    const drinksEscolhidos = valoresDaTela.drinksSelecionados || [];
  ...
  const opcoesCheckbox = cardapioDrinks.map((drink) => {
    return {
      label: drink.nome,
      value: drink.id,
    };
      ...
      <Row gutter={24}>
        <Col span={12}>
          <Card title="Dados do Evento" bordered={false}>
            ...
            >
              <Form.Item label="Nome do Cliente ou Evento" name="nomeCliente">
                <Input
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item label="Data do Evento" name="dataEvento">
                    <Input type="date" style={{ width: "100%" }} />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <Form.Item label="Horário de Início" name="horarioEvento">
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item label="Local do Evento?" name="regiaoFrete">
                    <Select
                ...
                <Col span={12}>
                  <Form.Item label="Estrutura de Copos" nam="tipoCopo">
                    <Select
          ...
          >
            ...
            <Button
              ...
              onClick={() =>
                gerarOrcamentoPDF({
                  resumo,
                  formDados: form.getFieldsValue(true),
                })
              }
